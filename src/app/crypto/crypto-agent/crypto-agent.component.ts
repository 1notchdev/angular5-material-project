...
@Component({
	selector: 'app-crypto-agent',
	templateUrl: 'crypto-agent.component.html',
	styleUrls: ['crypto-agent.component.scss']
})
export class CryptoAgentComponent implements OnInit, OnDestroy {
